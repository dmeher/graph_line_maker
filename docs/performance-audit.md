...
## Targeted update - 2026-08-22 (selected-source erasing)
...
Targeted validation on 2026-08-22: focused processor, source-layout, erase-geometry, layer-extras, and selected-erase-target tests passed **57/57**; `git diff --check` passed. Rendered UI validation was not run because it was not explicitly requested.
