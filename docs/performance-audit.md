...
## Targeted update - 2026-08-22 (selected-source erasing and 1% canvas zoom)
...
Targeted validation on 2026-08-22: focused processor, source-layout, erase-geometry, layer-extras, selected-erase-target, and canvas-zoom tests passed; `git diff --check` passed. Rendered UI validation was not run because it was not explicitly requested.
